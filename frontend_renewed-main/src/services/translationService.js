...
const dictionaries = {
  ...
  ta: {
    'Welcome': 'வரவேற்பு', 'Login': 'உள்நுழை', 'Logout': 'வெளியேறு', 'Home': 'முகப்பு', 'Patients': 'நோயாளிகள்', 'Add Patient': 'நோயாளியைச் சேர்க்க',
  },
  te: {
    'Welcome': 'స్వాగతం', 'Login': 'లాగిన్', 'Logout': 'లాగ్ఔట్', 'Home': 'హోమ్', 'Patients': 'రోగులు', 'Add Patient': 'రోగిని జోడించండి',
  },
  kn: {
    'Welcome': 'ಸ್ವಾಗತ', 'Login': 'ಲಾಗಿನ್', 'Logout': 'ಲಾಗೌಟ್', 'Home': 'ಮುಖಪುಟ', 'Patients': 'ರೋಗಿಗಳು', 'Add Patient': 'ರೋಗಿಯನ್ನು ಸೇರಿಸಿ',
  },
  bn: {
    'Welcome': 'স্বাগতম', 'Login': 'লগইন', 'Logout': 'লগআউট', 'Home': 'হোম', 'Patients': 'রোগী', 'Add Patient': 'রোগী যোগ করুন',
  }
};
