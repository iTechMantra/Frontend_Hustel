...
export default function DoctorDashboard() {
  console.log('DoctorDashboard component loading...');
  ...
  useEffect(() => {
    console.log('DoctorDashboard useEffect running...');
    
    const initializeDashboard = async () => {
      try {
        const currentUser = await getCurrentUser();
        console.log('DoctorDashboard currentUser:', currentUser);
        
        if (!currentUser || currentUser.role !== 'doctor') {
          console.log('DoctorDashboard: No current user or wrong role, redirecting to login');
        ...
        console.log('DoctorDashboard: Setting doctor data:', dummyDoctor);
        setDoctor(dummyDoctor);
        loadDoctorData();
        setLoading(false);
      } catch (error) {
        console.error('DoctorDashboard initialization error:', error);
        navigate('/doctor/login');
      }
    };
