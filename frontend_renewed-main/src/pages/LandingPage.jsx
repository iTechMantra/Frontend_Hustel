...
export default function LandingPage() {
  ...
  const features = [
    {
      icon: <Brain className="h-6 w-6 text_white" />,
  ...
  const roles = [
    ...
    },
    {
      ...
      title: "PHC Doctor",
      description:
        "Perform consultations, validate ASHA data, and manage care plans.",
    ...
    },
    {
      ...
      title: "ASHA Worker",
      description:
        "Offline-first EHR capture, reminders, training, and campaign participation.",
    ...
    },
    {
      role: "phc",
      title: "PHC Staff",
      description: "View offline stats, sync queue, and PHC-level reports.",
    ...
    },
    {
      role: "anm",
      title: "ANM",
      description: "Supervise ASHAs, monitor high-risk pregnancies, and coordinate field work.",
      icon: <Users className="h-8 w-8 text-white" />,
    ...
    },
    {
      role: "admin",
      title: "Admin",
      description: "System analytics, incentives, and configuration.",
      icon: <Users className="h-8 w-8 text-white" />,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 font-sans">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 leading-relaxed">
              {translate(
                "Mobile-first Offline EHR Companion for ASHA workers with secure local storage, background sync, and multilingual support."
              )}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button onClick={toggleLanguage} className="border-2 border-gray-300 hover:border-teal-500 text-gray-700 hover:text-teal-600 font-semibold py-3 px-8 rounded-xl transition-all duration-300 bg-white hover:bg-teal-50">
                {getToggleLanguageName()}
              </button>
            </div>
          </div>
      ...
      <section className="py-5 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {translate("Simple steps to access healthcare anywhere")}
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            ...
            <h3 className="text-xl font-bold mb-2">
              {translate("Step 1: Register")}
            </h3>
            <p className="text-gray-600">
              {translate(
                "Sign up as a patient, doctor, ASHA, or pharmacy to access the platform"
              )}
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            ...
            <h3 className="text-xl font-bold mb-2">
              {translate("Step 2: Consult / Upload")}
            </h3>
            <p className="text-gray-600">
              {translate(
                "Patients can consult doctors, upload health records, and track symptoms"
              )}
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">
            <Users className="text-4xl text-yellow-600 mx_auto mb-4" />
            <h3 className="text-xl font-bold mb-2">
              {translate("Step 3: Get Medicines")}
            </h3>
            <p className="text-gray-600">
              {translate(
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              {translate("Comprehensive Healthcare Solutions")}
            </h2>
      ...
      {/* Role Selection */}
      <section ref={roleSectionRef} className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
